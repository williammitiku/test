...
const Index = (props) => {
    ...
    const fetchData = () => {
        http
          .get('https://elite-water-api.herokuapp.com/api/item/getAll', {
      ...
      const fetchOrders = () => {
        http
          .get('https://elite-water-api.herokuapp.com/api/order/getAll', {
      ...
      const fetchTodayOrders = () => {
        http
          .get('https://elite-water-api.herokuapp.com/api/order/getAllToday', {
      ...
      const fetchWeeklyOrders = () => {
        http
          .get('https://elite-water-api.herokuapp.com/api/order/getAllWeekly', {
      ...
      const fetchOrderCount = () => {
        http
          .get('https://elite-water-api.herokuapp.com/api/order/getAllOrdersCount', {
      ...
      const fetchDrivers = () => {
        http
          .get('https://elite-water-api.herokuapp.com/api/user/listDrivers', {
