...
const Index = (props) => {
  ...
  useEffect(() => {
    http
      .get("https://elitewater-admin.com:4001/api/order/getAllOrdersCount")
      .then((response) => {
        response.data?.ordersCount?.map((item) => {
          
          age.push(item?.count);
          salary.push(item?._id);
        });
        setCategory(salary);
        setData(age);
        // setObject({
  ...
  const fetchData = () => {
    http
      .get("https://elitewater-admin.com:4001/api/item/getAll", {})
      .then((response) => {
  ...
  const fetchOrders = () => {
    http
      .get("https://elitewater-admin.com:4001/api/order/getAll", {})
      .then((response) => {
  ...
  const fetchTodayOrders = () => {
    http
      .get('https://elitewater-admin.com:4001/api/order/getAllToday', {
  ...
  const fetchWeeklyOrders = () => {
    http
      .get('https://elitewater-admin.com:4001/api/order/getAllWeekly', {
  ...
  const DisplayData = userss?.orders?.slice(0,5).map((items) => {
    return (
  ...
  const fetchOrderCount = () => {
    http
      .get('http://157.230.82.96:3000/api/order/getAllOrdersCount', {
  ...
  const DisplayDataTable = chart?.ordersCount?.slice(0,5).map((items) => {
    return (
                    <tr>
                      <td>
  ...
  const fetchDrivers = () => {
    http
      .get("http://157.230.82.96:3000/api/user/listDrivers", {})
      .then((response) => {
  ...
  useEffect(() => {
    ...
    const getSocialrecord = async () => {
      ...
      for (let i = 0; i < ordersCount?.ordersCount?.length; i++) {
        socialMedianame?.push(ordersCount?.ordersCount[i]._id);
        socialMedivalue?.push(ordersCount?.ordersCount[i].count);
      }
                  ...
                  <div className="card-body">
                    <div className="progress-widget">
                      ...
                      <div className="progress-detail">
                        ...
                        <CountUp start={0} end={today?.orders} duration={3} />
                          </h4>
                      </div>
                    </div>
                  </div>
          ...
          <Row>
                ...
                <div className="flex-wrap card-header d-flex justify-content-between">
                  <div className="header-title">
                    <h4 className="card-title">
                      Total Order {userss?.orders?.length}
                    </h4>
            ...
            <Col md="12" xl="12">
              <div className="card" data-aos="fade-up" data-aos-delay="1000">
                <div className="flex-wrap card-header d-flex justify-content-between">
                  <div className="header-title">
                    <h4 className="card-title">Item Sales Report</h4>
                  </div>
                  ...
                  <div className="p-4 border border-white rounded primary-gradient-card">
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        <p className="mb-0">Elite Water</p>
                      </div>
                    </div>
                    <div className="my-4">
