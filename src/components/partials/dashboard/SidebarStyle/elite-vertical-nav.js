       ...
       <>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <CustomToggle eventKey="sidebar-special" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Manage Requests</span>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav">
                            ...
                            <li className="nav-item">
                                ...
                                <span className="item-name">All Orders</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix="nav-item">
                    <CustomToggle eventKey="sidebar-user" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Manage Driver</span>
                        <i className="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        ...
                        <li className="nav-item">
                                <Link className={`${location.pathname === '/dashboard/app/driver-add' ? 'active' : ''} nav-link`} to="/dashboard/app/driver-add">
                                    ...
                                    <i className="sidenav-mini-icon"> E </i>
                                    <span className="item-name">Add Driver</span>
                                </Link>
                            </li>
                            ...
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/dashboard/app/user-list' ? 'active' : ''} nav-link`} to="/dashboard/app/user-list">
                                    ...
                                    <span className="item-name">View Driver</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
                ...
                <Accordion.Item as="li" eventKey="sidebar-table" bsPrefix="nav-item">
                 <CustomToggle eventKey="sidebar-table" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        ...
                        <span className="item-name">Delivery Type</span>
                        <i className="right-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="sidebar-table">
                        <ul className="sub-nav">
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/dashboard/deliveryAdd' ? 'active' :''} nav-link`} to="/dashboard/deliveryAdd">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">Add Delivery Type</span>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={`${location.pathname === '/dashboard/deliveryList' ? 'active' : ''} nav-link`} to="/dashboard/deliveryList">
                                    <i className="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span className="item-name">View Delivery Type</span>
                                </Link>
                            </li>
                        </ul>
                    </Accordion.Collapse>
